...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reports/analytics/export/monthly', [FeedbackReportController::class, 'exportAnalyticsExcel'])->name('reports.analytics.export.monthly');
    Route::get('/reports/analytics/export/quarterly', [FeedbackReportController::class, 'exportQuarterlyExcel'])->name('reports.analytics.export.quarterly');
