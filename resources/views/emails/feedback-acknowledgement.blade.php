...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for taking the time to provide feedback to {{ $hospitalName }}. We have received your submission and it has been forwarded to our Quality Assurance team for review.</p>
            ...
            <p style="text-align: center;">
                <a href="{{ $appUrl }}/track?reference_no={{ $referenceNo }}" class="button">Track Your Feedback</a>
            </p>
