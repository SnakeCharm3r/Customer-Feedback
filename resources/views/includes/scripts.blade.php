   ...
   <script src="{{ asset('assets/js/pages/dashboard-learning.init.js') }}"></script>
   ...
   <script>
      document.addEventListener('DOMContentLoaded', function () {
         ...
         const toastTone = toneMap['{{ session('toast_type', 'success') }}'] || 'success';
         ...
         container.innerHTML = '<div class="toast align-items-center text-bg-' + toastTone + ' border-0 shadow" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3500">'
            + '<div class="d-flex">'
            + '<div class="toast-body">{{ addslashes(session('toast')) }}</div>'
